...
class ModifyAProduct extends StatefulWidget {
  const ModifyAProduct({Key? key}) : super(key: key);
  static String id = 'ModifyAProduct';

  @override
  State<ModifyAProduct> createState() => _ModifyAProductState();
}

class _ModifyAProductState extends State<ModifyAProduct> {
                    ...
                    Row(
                      ...
                      children: <Widget>[
                        ElevatedButton(
                          ...
                          child: const Text('تعديل المنتج', style: TextStyle(color: Colors.black),),
                        ),
                        const SizedBox(width: 20,),
                        ElevatedButton(
                          style: ButtonStyle(
                          ...
                          child: const Text('حذف المنتج', style: TextStyle(color: Colors.black),),
                        ),
                        // Builder(
