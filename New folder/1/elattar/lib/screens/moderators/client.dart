            ...
            child: SingleChildScrollView(
              child: Column(
                  children: <Widget>[
                    ...
                    const Text('إختيار العميل', style: TextStyle(fontSize: 20),),
                    const SizedBox(height: 20,),
                    Padding(
                    ...
                    // ),
                    const SizedBox(height: 20,),
                    const Text('بيانات المنتج', style: TextStyle(fontSize: 20),),
                    const SizedBox(height: 20,),
                    Padding(
                      padding: const EdgeInsets.symmetric(horizontal: 30),
                      child: Directionality(
                    ...
                    const SizedBox(height: 10),
                    const Text('لون المنتج'),
                    const Text('مقاس المنتج'),
                    const Text('سعر المنتج'),
                    const Text('إجمالي سعر طلب المنتج'),
                    // Directionality(
                    //   textDirection: TextDirection.rtl,
                    //   child:TextFormField(
                    //     keyboardType: TextInputType.name,
                    ...
                    Row(
                      ...
                      children: <Widget>[
                        ElevatedButton(
                          ...
                          child: const Text('تسجيل الطلب', style: TextStyle(color: Colors.black),),
                        ),
                        // Builder(
